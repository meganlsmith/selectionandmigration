...
mkdir -p SLiM-testing-redo-revisions/fsc_linkedp1_scaled_5000_nomig_15percent
cd SLiM-testing-redo-revisions/fsc_linkedp1_scaled_5000_nomig_15percent
for i in {0..100}
do
  mkdir -p rep_$i;
  cd rep_$i;
  cp ../../../../SFS-redo-revision/SLiM-testing-redo-revisions/fsc/nomig_linkedp1_scaled_5000_15percent/rep_$i.fs ./Migration_5000_DSFS.obs;
