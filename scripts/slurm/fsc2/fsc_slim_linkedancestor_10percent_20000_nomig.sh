#!/bin/bash
#SBATCH -A r00279
#SBATCH -J fsc_linkedancestor_scaled_20000_nomig_10percent
#SBATCH -p general
#SBATCH -o fsc_linkedancestor_scaled_20000_nomig_10percent_%j.txt
#SBATCH -e fsc_linkedancestor_scaled_20000_nomig_10percent_%j.err
...
mkdir -p SLiM-testing-redo-revisions/fsc_linkedancestor_scaled_20000_nomig_10percent
cd SLiM-testing-redo-revisions/fsc_linkedancestor_scaled_20000_nomig_10percent
for i in {0..100}
do
  mkdir -p rep_$i;
  cd rep_$i;
  cp ../../../../SFS-redo-revision/SLiM-testing-redo-revisions/fsc/nomig_linkedancestor_scaled_20000_10percent/rep_$i.fs ./Migration_20000_DSFS.obs;
