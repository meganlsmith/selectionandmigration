...
mkdir -p DROSOPHILA-testing-redo/fsc_bgs_drosophila_1250_p1_p2
cd DROSOPHILA-testing-redo/fsc_bgs_drosophila_1250_p1_p2
for i in {0..100}
do
  mkdir -p rep_$i;
  cd rep_$i;
  cp ../../../../SFS-redo/DROSOPHILA-testing-redo/fsc/p1_p2_bgs_drosophila_1250/rep_$i.fs ./Migration_1250_DSFS.obs;
