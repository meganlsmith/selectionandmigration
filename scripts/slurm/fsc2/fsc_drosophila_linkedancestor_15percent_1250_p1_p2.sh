...
mkdir -p DROSOPHILA-testing-redo/fsc_linkedancestor_drosophila_1250_p1_p2_15percent
cd DROSOPHILA-testing-redo/fsc_linkedancestor_drosophila_1250_p1_p2_15percent
for i in {0..100}
do
  mkdir -p rep_$i;
  cd rep_$i;
  cp ../../../../SFS-redo/DROSOPHILA-testing-redo/fsc/p1_p2_linkedancestor_drosophila_1250_15percent/rep_$i.fs ./Migration_1250_DSFS.obs;
