...
mkdir -p SLiM-testing-redo/fsc_linkedp1_scaled_20000_p1_p2_5percent
cd SLiM-testing-redo/fsc_linkedp1_scaled_20000_p1_p2_5percent
for i in {0..100}
do
  mkdir -p rep_$i;
  cd rep_$i;
  cp ../../../../SFS-redo/SLiM-testing-redo/fsc/p1_p2_linkedp1_scaled_20000_5percent/rep_$i.fs ./Migration_20000_DSFS.obs;
