#!/bin/bash
#SBATCH -A general
#SBATCH -J fsc_linkedancestor_drosophila_1250_p2_p1_15percent
#SBATCH -p general
#SBATCH -o fsc_linkedancestor_drosophila_1250_p2_p1_15percent_%j.txt
#SBATCH -e fsc_linkedancestor_drosophila_1250_p2_p1_15percent_%j.err
...
mkdir -p DROSOPHILA-testing-redo/fsc_linkedancestor_drosophila_1250_p2_p1_15percent
cd DROSOPHILA-testing-redo/fsc_linkedancestor_drosophila_1250_p2_p1_15percent
for i in {0..100}
do
  mkdir -p rep_$i;
  cd rep_$i;
  cp ../../../../SFS-redo/DROSOPHILA-testing-redo/fsc/p2_p1_linkedancestor_drosophila_1250_15percent/rep_$i.fs ./Migration_1250_DSFS.obs;
