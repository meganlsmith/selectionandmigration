#!/bin/bash
#SBATCH -A general
#SBATCH -J fsc_linkedp1_scaled_20000_p2_p1_10percent
#SBATCH -p general
#SBATCH -o fsc_linkedp1_scaled_20000_p2_p1_10percent_%j.txt
#SBATCH -e fsc_linkedp1_scaled_20000_p2_p1_10percent_%j.err
...
mkdir -p SLiM-testing-redo/fsc_linkedp1_scaled_20000_p2_p1_10percent
cd SLiM-testing-redo/fsc_linkedp1_scaled_20000_p2_p1_10percent
for i in {0..100}
do
  mkdir -p rep_$i;
  cd rep_$i;
  cp ../../../../SFS-redo/SLiM-testing-redo/fsc/p2_p1_linkedp1_scaled_20000_10percent/rep_$i.fs ./Migration_20000_DSFS.obs;
