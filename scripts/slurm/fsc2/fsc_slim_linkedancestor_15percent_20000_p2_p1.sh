#!/bin/bash
#SBATCH -A general
#SBATCH -J fsc_linkedancestor_scaled_20000_p2_p1_15percent
#SBATCH -p general
#SBATCH -o fsc_linkedancestor_scaled_20000_p2_p1_15percent_%j.txt
#SBATCH -e fsc_linkedancestor_scaled_20000_p2_p1_15percent_%j.err
...
mkdir -p SLiM-testing-redo/fsc_linkedancestor_scaled_20000_p2_p1_15percent
cd SLiM-testing-redo/fsc_linkedancestor_scaled_20000_p2_p1_15percent
for i in {0..100}
do
  mkdir -p rep_$i;
  cd rep_$i;
  cp ../../../../SFS-redo/SLiM-testing-redo/fsc/p2_p1_linkedancestor_scaled_20000_15percent/rep_$i.fs ./Migration_20000_DSFS.obs;
