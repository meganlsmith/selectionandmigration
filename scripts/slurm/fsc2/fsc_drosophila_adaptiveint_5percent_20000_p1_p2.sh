#!/bin/bash
#SBATCH -A r00279
#SBATCH -J fsc_adaptiveint_drosophila_20000_p1_p2_5percent
#SBATCH -p general
#SBATCH -o fsc_adaptiveint_drosophila_20000_p1_p2_5percent_%j.txt
#SBATCH -e fsc_adaptiveint_drosophila_20000_p1_p2_5percent_%j.err
...
mkdir -p DROSOPHILA-testing-redo-revisions-v2/fsc_adaptiveint_drosophila_20000_p1_p2_5percent
cd DROSOPHILA-testing-redo-revisions-v2/fsc_adaptiveint_drosophila_20000_p1_p2_5percent
for i in {0..100}
do
  mkdir -p rep_$i;
  cd rep_$i;
  cp ../../../../SFS-redo-revision/DROSOPHILA-testing-redo-revisions-v2/fsc/p1_p2_adaptiveint_drosophila_20000_5percent/rep_$i.fs ./Migration_20000_DSFS.obs;
