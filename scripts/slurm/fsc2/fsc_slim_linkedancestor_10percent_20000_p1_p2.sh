...
mkdir -p SLiM-testing-redo/fsc_linkedancestor_scaled_20000_p1_p2_10percent
cd SLiM-testing-redo/fsc_linkedancestor_scaled_20000_p1_p2_10percent
for i in {0..100}
do
  mkdir -p rep_$i;
  cd rep_$i;
  cp ../../../../SFS-redo/SLiM-testing-redo/fsc/p1_p2_linkedancestor_scaled_20000_10percent/rep_$i.fs ./Migration_20000_DSFS.obs;
