#!/bin/bash
#SBATCH -A general
#SBATCH -J fsc_linkedancestor_drosophila_1250_p2_p1_5percent
#SBATCH -p general
#SBATCH -o fsc_linkedancestor_drosophila_1250_p2_p1_5percent_%j.txt
#SBATCH -e fsc_linkedancestor_drosophila_1250_p2_p1_5percent_%j.err
...
mkdir -p DROSOPHILA-testing-redo/fsc_linkedancestor_drosophila_1250_p2_p1_5percent
cd DROSOPHILA-testing-redo/fsc_linkedancestor_drosophila_1250_p2_p1_5percent
for i in {0..100}
do
  mkdir -p rep_$i;
  cd rep_$i;
  cp ../../../../SFS-redo/DROSOPHILA-testing-redo/fsc/p2_p1_linkedancestor_drosophila_1250_5percent/rep_$i.fs ./Migration_1250_DSFS.obs;
