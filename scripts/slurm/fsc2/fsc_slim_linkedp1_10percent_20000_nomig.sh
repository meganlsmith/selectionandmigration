...
mkdir -p SLiM-testing-redo/fsc_linkedp1_scaled_20000_nomig_10percent
cd SLiM-testing-redo/fsc_linkedp1_scaled_20000_nomig_10percent
for i in {0..100}
do
  mkdir -p rep_$i;
  cd rep_$i;
  cp ../../../../SFS-redo/SLiM-testing-redo/fsc/nomig_linkedp1_scaled_20000_10percent/rep_$i.fs ./Migration_20000_DSFS.obs;
