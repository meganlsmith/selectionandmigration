...
mkdir -p SLiM-testing-redo/fsc_neutral_scaled_20000_nomig
cd SLiM-testing-redo/fsc_neutral_scaled_20000_nomig
for i in {0..100}
do
  mkdir -p rep_$i;
  cd rep_$i;
  cp ../../../../SFS-redo/SLiM-testing-redo/fsc/nomig_neutral_scaled_20000/rep_$i.fs ./Migration_20000_DSFS.obs;
