#!/bin/bash
#SBATCH -A general
#SBATCH -J fsc_linkedp1_scaled_1250_p2_p1_5percent
#SBATCH -p general
#SBATCH -o fsc_linkedp1_scaled_1250_p2_p1_5percent_%j.txt
#SBATCH -e fsc_linkedp1_scaled_1250_p2_p1_5percent_%j.err
...
mkdir -p SLiM-testing-redo/fsc_linkedp1_scaled_1250_p2_p1_5percent
cd SLiM-testing-redo/fsc_linkedp1_scaled_1250_p2_p1_5percent
for i in {0..100}
do
  mkdir -p rep_$i;
  cd rep_$i;
  cp ../../../../SFS-redo/SLiM-testing-redo/fsc/p2_p1_linkedp1_scaled_1250_5percent/rep_$i.fs ./Migration_1250_DSFS.obs;
