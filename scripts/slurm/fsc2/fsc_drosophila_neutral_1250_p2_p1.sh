#!/bin/bash
#SBATCH -A general
#SBATCH -J fsc_neutral_drosophila_1250_p2_p1
#SBATCH -p general
#SBATCH -o fsc_neutral_drosophila_1250_p2_p1_%j.txt
#SBATCH -e fsc_neutral_drosophila_1250_p2_p1_%j.err
...
mkdir -p DROSOPHILA-testing-redo/fsc_neutral_drosophila_1250_p2_p1
cd DROSOPHILA-testing-redo/fsc_neutral_drosophila_1250_p2_p1
for i in {0..100}
do
  mkdir -p rep_$i;
  cd rep_$i;
  cp ../../../../SFS-redo/DROSOPHILA-testing-redo/fsc/p2_p1_neutral_drosophila_1250/rep_$i.fs ./Migration_1250_DSFS.obs;
