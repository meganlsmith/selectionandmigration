#!/bin/bash
#SBATCH -A r00279
#SBATCH -J fsc_adaptiveint_scaled_20000_p1_p2_15percent
#SBATCH -p general
#SBATCH -o fsc_adaptiveint_scaled_20000_p1_p2_15percent_%j.txt
#SBATCH -e fsc_adaptiveint_scaled_20000_p1_p2_15percent_%j.err
...
mkdir -p SLiM-testing-redo-revisions/fsc_adaptiveint_scaled_20000_p1_p2_15percent
cd SLiM-testing-redo-revisions/fsc_adaptiveint_scaled_20000_p1_p2_15percent
for i in {0..100}
do
  mkdir -p rep_$i;
  cd rep_$i;
  cp ../../../../SFS-redo-revision/SLiM-testing-redo-revisions/fsc/p1_p2_adaptiveint_scaled_20000_15percent/rep_$i.fs ./Migration_20000_DSFS.obs;
