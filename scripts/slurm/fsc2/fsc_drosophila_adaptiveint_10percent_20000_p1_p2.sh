...
mkdir -p DROSOPHILA-testing-redo/fsc_adaptiveint_drosophila_20000_p1_p2_10percent
cd DROSOPHILA-testing-redo/fsc_adaptiveint_drosophila_20000_p1_p2_10percent
for i in {0..100}
do
  mkdir -p rep_$i;
  cd rep_$i;
  cp ../../../../SFS-redo/DROSOPHILA-testing-redo/fsc/p1_p2_adaptiveint_drosophila_20000_10percent/rep_$i.fs ./Migration_20000_DSFS.obs;
