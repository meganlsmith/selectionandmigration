#!/bin/bash
#SBATCH -A r00279
#SBATCH -J fsc_balancing_scaled_1250_p1_p2_5percent
#SBATCH -p general
#SBATCH -o fsc_balancing_scaled_1250_p1_p2_5percent_%j.txt
#SBATCH -e fsc_balancing_scaled_1250_p1_p2_5percent_%j.err
...
mkdir -p SLiM-testing-redo-revisions/fsc_balancing_scaled_1250_p1_p2_5percent
cd SLiM-testing-redo-revisions/fsc_balancing_scaled_1250_p1_p2_5percent
for i in {0..100}
do
  mkdir -p rep_$i;
  cd rep_$i;
  cp ../../../../SFS-redo-revision/SLiM-testing-redo-revisions/fsc/p1_p2_balancing_scaled_1250_5percent/rep_$i.fs ./Migration_1250_DSFS.obs;
