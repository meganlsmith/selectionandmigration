...
mkdir -p SLiM-testing-redo/fsc_linkedancestor_scaled_1250_p1_p2_5percent
cd SLiM-testing-redo/fsc_linkedancestor_scaled_1250_p1_p2_5percent
for i in {0..100}
do
  mkdir -p rep_$i;
  cd rep_$i;
  cp ../../../../SFS-redo/SLiM-testing-redo/fsc/p1_p2_linkedancestor_scaled_1250_5percent/rep_$i.fs ./Migration_1250_DSFS.obs;
