#!/bin/bash
#SBATCH -A r00279
#SBATCH -J fsc_linkedp1_drosophila_1250_p1_p2_15percent
#SBATCH -p general
#SBATCH -o fsc_linkedp1_drosophila_1250_p1_p2_15percent_%j.txt
#SBATCH -e fsc_linkedp1_drosophila_1250_p1_p2_15percent_%j.err
...
mkdir -p DROSOPHILA-testing-redo-revisions-v2/fsc_linkedp1_drosophila_1250_p1_p2_15percent
cd DROSOPHILA-testing-redo-revisions-v2/fsc_linkedp1_drosophila_1250_p1_p2_15percent
for i in {0..100}
do
  mkdir -p rep_$i;
  cd rep_$i;
  cp ../../../../SFS-redo-revision/DROSOPHILA-testing-redo-revisions-v2/fsc/p1_p2_linkedp1_drosophila_1250_15percent/rep_$i.fs ./Migration_1250_DSFS.obs;
