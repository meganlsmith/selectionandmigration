#!/bin/bash
#SBATCH -A r00279
#SBATCH -J fsc_balancing_scaled_20000_nomig_15percent
#SBATCH -p general
#SBATCH -o fsc_balancing_scaled_20000_nomig_15percent_%j.txt
#SBATCH -e fsc_balancing_scaled_20000_nomig_15percent_%j.err
...
mkdir -p SLiM-testing-redo-revisions/fsc_balancing_scaled_20000_nomig_15percent
cd SLiM-testing-redo-revisions/fsc_balancing_scaled_20000_nomig_15percent
for i in {0..100}
do
  mkdir -p rep_$i;
  cd rep_$i;
  cp ../../../../SFS-redo-revision/SLiM-testing-redo-revisions/fsc/nomig_balancing_scaled_20000_15percent/rep_$i.fs ./Migration_20000_DSFS.obs;
