...
mkdir -p DROSOPHILA-testing-redo/fsc_linkedp1_drosophila_20000_nomig_5percent
cd DROSOPHILA-testing-redo/fsc_linkedp1_drosophila_20000_nomig_5percent
for i in {0..100}
do
  mkdir -p rep_$i;
  cd rep_$i;
  cp ../../../../SFS-redo/DROSOPHILA-testing-redo/fsc/nomig_linkedp1_drosophila_20000_5percent/rep_$i.fs ./Migration_20000_DSFS.obs;
