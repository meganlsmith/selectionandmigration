#!/bin/bash
#SBATCH -A r00279
#SBATCH -J fsc_bgs_drosophila_20000_nomig
#SBATCH -p general
#SBATCH -o fsc_bgs_drosophila_20000_nomig_%j.txt
#SBATCH -e fsc_bgs_drosophila_20000_nomig_%j.err
...
mkdir -p DROSOPHILA-testing-redo-revisions-v2/fsc_bgs_drosophila_20000_nomig
cd DROSOPHILA-testing-redo-revisions-v2/fsc_bgs_drosophila_20000_nomig
for i in {0..100}
do
  mkdir -p rep_$i;
  cd rep_$i;
  cp ../../../../SFS-redo-revision/DROSOPHILA-testing-redo-revisions-v2/fsc/nomig_bgs_drosophila_20000/rep_$i.fs ./Migration_20000_DSFS.obs;
