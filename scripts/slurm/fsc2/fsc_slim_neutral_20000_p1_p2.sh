#!/bin/bash
#SBATCH -A r00279
#SBATCH -J fsc_neutral_scaled_20000_p1_p2
#SBATCH -p general
#SBATCH -o fsc_neutral_scaled_20000_p1_p2_%j.txt
#SBATCH -e fsc_neutral_scaled_20000_p1_p2_%j.err
...
mkdir -p SLiM-testing-redo-revisions/fsc_neutral_scaled_20000_p1_p2
cd SLiM-testing-redo-revisions/fsc_neutral_scaled_20000_p1_p2
for i in {0..100}
do
  mkdir -p rep_$i;
  cd rep_$i;
  cp ../../../../SFS-redo-revision/SLiM-testing-redo-revisions/fsc/p1_p2_neutral_scaled_20000/rep_$i.fs ./Migration_20000_DSFS.obs;
