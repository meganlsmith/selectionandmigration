...
mkdir -p DROSOPHILA-testing-redo/fsc_neutral_drosophila_20000_p1_p2
cd DROSOPHILA-testing-redo/fsc_neutral_drosophila_20000_p1_p2
for i in {0..100}
do
  mkdir -p rep_$i;
  cd rep_$i;
  cp ../../../../SFS-redo/DROSOPHILA-testing-redo/fsc/p1_p2_neutral_drosophila_20000/rep_$i.fs ./Migration_20000_DSFS.obs;
