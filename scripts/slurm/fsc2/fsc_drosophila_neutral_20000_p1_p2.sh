#!/bin/bash
#SBATCH -A r00279
#SBATCH -J fsc_neutral_drosophila_20000_p1_p2
#SBATCH -p general
#SBATCH -o fsc_neutral_drosophila_20000_p1_p2_%j.txt
#SBATCH -e fsc_neutral_drosophila_20000_p1_p2_%j.err
...
mkdir -p DROSOPHILA-testing-redo-revisions-v2/fsc_neutral_drosophila_20000_p1_p2
cd DROSOPHILA-testing-redo-revisions-v2/fsc_neutral_drosophila_20000_p1_p2
for i in {0..100}
do
  mkdir -p rep_$i;
  cd rep_$i;
  cp ../../../../SFS-redo-revision/DROSOPHILA-testing-redo-revisions-v2/fsc/p1_p2_neutral_drosophila_20000/rep_$i.fs ./Migration_20000_DSFS.obs;
