...
mkdir -p DROSOPHILA-testing-redo/fsc_linkedancestor_drosophila_20000_nomig_15percent
cd DROSOPHILA-testing-redo/fsc_linkedancestor_drosophila_20000_nomig_15percent
for i in {0..100}
do
  mkdir -p rep_$i;
  cd rep_$i;
  cp ../../../../SFS-redo/DROSOPHILA-testing-redo/fsc/nomig_linkedancestor_drosophila_20000_15percent/rep_$i.fs ./Migration_20000_DSFS.obs;
