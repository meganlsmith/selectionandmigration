...
mkdir -p SLiM-testing-redo/fsc_bgs_scaled_1250_p1_p2
cd SLiM-testing-redo/fsc_bgs_scaled_1250_p1_p2
for i in {0..100}
do
  mkdir -p rep_$i;
  cd rep_$i;
  cp ../../../../SFS-redo/SLiM-testing-redo/fsc/p1_p2_bgs_scaled_1250/rep_$i.fs ./Migration_1250_DSFS.obs;
