...
python python_scripts/sample_parameters_slim.py -s p1_p2_linkedancestor_drosophila.slim -r 1500 -d 2000000

python ./python_scripts/tskit_Drosophilamaps_to_msout_v3.py -d 2000000 -r 1500 -s ./slim_scripts/p1_p2_linkedancestor_drosophila.slim --prefix p1_p2_linkedancestor_drosophila -p ../params/p1_p2_linkedancestor_drosophila_params_2000000.txt -c 24 -f sweep -x /N/project/Prophysaongenomics/FILET_Organized_24January2023/programs/build/slim --scale 100 --seed $random_seed
